  ...
  return (
    <div className="py-8">
      <div className="flex items-center gap-3 mb-4">
        ...
        <h2 className="text-2xl font-bold text-white px-4 md:px-12">{collection.name}</h2>
      ...
      >
        <CarouselContent className="-ml-2 md:-ml-4 px-4 md:px-12">
          {movies && movies.map((movie) => (
            <CarouselItem key={movie.id} className="pl-2 md:pl-4 basis-full sm:basis-1/2 md:basis-1/3 lg:basis-1/4 xl:basis-1/6">
              <div 
